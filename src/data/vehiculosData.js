...
import n400Pasajeros from "../assets/n400Pasajeros.png";
...
const vehiculosData = {
  Camionetas: [
...

    {
      ...
      traccion: "4x4 con caja de transferencia",
      seguridad: [
        "6 airbags",
  ...
  "SUV & Crossovers": [
...

    {
      ...
      transmision: "Automática de 6 velocidades",
      combustible: "Diésel",
      traccion: "4x4 con acople electrónico",
      seguridad: [
        "6 airbags",
...

    {
      ...
      equipamiento: [
        "Pantallas de entretenimiento de 12.6 pulgadas para los pasajeros traseros",
        "Sistema de sonido Premium Bose con 10 parlantes",
        "Suspensión adaptativa Magnetic Ride Control",
        "Capacidad para hasta 8 pasajeros",
      ],
    },

    {
      ...
      imagen: tahoe,
      descripcion: "Potencia, lujo y tecnología para toda la familia.",
      precio: "Desde $89.990",
      motor: "5.3L V8 EcoTec3",
      potencia: "355 HP",
      transmision: "Automática de 10 velocidades",
      ...
      equipamiento: [
        "Pantalla táctil de 17.7 pulgadas",
  ...
  "Híbridos": [
        {
      id: 10,
      nombre: "Chevrolet Captiva Híbrida",
      imagen: captivaHibrida,
      ...
      seguridad: [
        ...
        "Cámara de entorno de 360 grados",
      ],
      equipamiento: [
        "Cuadro de instrumentos digital avanzado",
        "Modos de manejo EV / HEV",
  ...
  Vans: [
    {
      id: 11,
      nombre: "Chevrolet N400 Cargo",
      imagen: n400,
      descripcion: "Ideal para trabajo y transporte de carga.",
      precio: "Desde $13.490",
      motor: "1.5L VVT de 4 cilindros",
      potencia: "103 HP",
      transmision: "Manual de 5 velocidades",
      combustible: "Gasolina",
      traccion: "Tracción trasera (RWD)",
      seguridad: [
        "2 airbags",
        "Frenos ABS con EBD",
      ...
      equipamiento: [
        "Aire acondicionado",
        "Radio con USB y entrada auxiliar",
...

    {
      ...
      descripcion:
        "La combinación perfecta de espacio, economía y comodidad para tu negocio.",
      precio: "Desde $14.990",
      motor: "1.5L VVT de 4 cilindros",
      potencia: "103 HP",
      transmision: "Manual de 5 velocidades",
      ...
      equipamiento: [
        ...
        "Radio AM/FM con USB y auxiliar",
  ...
  "Eléctricos": [
        {
      id: 13,
      nombre: "Chevrolet Captiva EV",
      imagen: captivaEV,
      descripcion: "El futuro de la movilidad eléctrica de Chevrolet.",
      precio: "Desde $59.990",
      motor: "Motor Eléctrico Ultium",
      potencia: "288 HP",
      transmision: "Automática de 1 velocidad",
      combustible: "Eléctrico (Batería de 85 kWh)",
      traccion: "AWD (Tracción total electrónica)",
      seguridad: [
        "8 airbags",
        "Chevy Safety Assist",
      ...
      equipamiento: [
        ...
        "Panel de instrumentos digital de 11 pulgadas",
        "Autonomía de hasta 449 km",
        "Compuerta trasera con apertura manos libres",
      ],
    },

    {
      ...
      imagen: sparkEUV,
      descripcion:
        "Eléctrico, compacto y perfecto para la movilidad urbana.",
      precio: "Desde $26.990",
